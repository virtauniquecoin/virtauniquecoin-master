...
#ifndef _VIRTAUNIQUECOINRPC_H_
#define _VIRTAUNIQUECOINRPC_H_ 1
...
// virtauniquecoin RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // virtauniquecoin is not connected
...
/**
 * virtauniquecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
