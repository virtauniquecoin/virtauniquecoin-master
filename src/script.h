...
#ifndef H_VIRTAUNIQUECOIN_SCRIPT
#define H_VIRTAUNIQUECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CvirtauniquecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, virtauniquecoin always counted CHECKMULTISIGs
